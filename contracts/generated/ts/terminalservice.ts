...
// ============================================================================
// TerminalService Client Class
// ============================================================================

class TerminalServiceClientImpl {
  ...
  async Open(req: OpenRequest): Promise<OpenResponse> {
    return this.caller.call<OpenRequest, OpenResponse>(
      this.edgeId,
      'TerminalService',
      'Open',
      req
  ...
  async Input(req: InputRequest): Promise<InputResponse> {
    return this.caller.call<InputRequest, InputResponse>(
      this.edgeId,
      'TerminalService',
      'Input',
      req
  ...
  async Resize(req: ResizeRequest): Promise<ResizeResponse> {
    return this.caller.call<ResizeRequest, ResizeResponse>(
      this.edgeId,
      'TerminalService',
      'Resize',
      req
  ...
  async StreamOutput(req: StreamOutputRequest, handler: (resp: StreamOutputResponse) => void): Promise<Subscription> {
    return this.caller.subscribe<StreamOutputRequest, StreamOutputResponse>(
      this.edgeId,
      'TerminalService',
      'StreamOutput',
      req,
...
// ============================================================================
// TerminalService Service Descriptor (Embedded AI Metadata)
// ============================================================================

const descriptor: ServiceDescriptor = {
  name: "TerminalService",
  version: "1.0.0",
  description: "TerminalService provides PTY terminal access via node-pty. No SSH needed — all terminal access is via Dink streaming.",
  methods: [
    {
      name: "CreateSession",
...
// ============================================================================
// TerminalService Companion Object (Primary Export)
// ============================================================================

/**
 * TerminalService companion object with embedded AI metadata.
 * 
 * Usage:
 *   import { TerminalService } from './generated';
 *   
 *   // Create client
 *   const client = new TerminalService.Client(edgeId, caller);
 *   
 *   // Access embedded AI metadata (no network call)
 *   const serviceAI = TerminalService.descriptor.aiContext;
 *   const methodAI = TerminalService.getMethodAI('SomeMethod');
 *   const llmTxt = TerminalService.getLLMContext();
 */
export const TerminalService = {
  /** Client class for making RPC calls */
  Client: TerminalServiceClientImpl,
...
/** @deprecated Use TerminalService.Client instead */
export const TerminalServiceClient = TerminalServiceClientImpl;

/** @deprecated Use TerminalService.descriptor instead */
export const TerminalServiceDescriptor = descriptor;

/** @deprecated Use TerminalService.Definition instead */
export const TerminalServiceDefinition = definition;

/** @deprecated Use TerminalService.getLLMContext() instead */
export function getTerminalServiceLLMContext(): string {
