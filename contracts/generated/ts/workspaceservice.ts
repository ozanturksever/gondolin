...
// ============================================================================
// WorkspaceService Client Class
// ============================================================================

class WorkspaceServiceClientImpl {
  ...
  async CreateSandbox(req: CreateSandboxRequest): Promise<CreateSandboxResponse> {
    return this.caller.call<CreateSandboxRequest, CreateSandboxResponse>(
      this.edgeId,
      'WorkspaceService',
      'CreateSandbox',
      req
  ...
  async DestroySandbox(req: DestroySandboxRequest): Promise<DestroySandboxResponse> {
    return this.caller.call<DestroySandboxRequest, DestroySandboxResponse>(
      this.edgeId,
      'WorkspaceService',
      'DestroySandbox',
      req
  ...
  async GetStatus(req: GetStatusRequest): Promise<GetStatusResponse> {
    return this.caller.call<GetStatusRequest, GetStatusResponse>(
      this.edgeId,
      'WorkspaceService',
      'GetStatus',
      req
  ...
  async ListSandboxes(req: ListSandboxesRequest): Promise<ListSandboxesResponse> {
    return this.caller.call<ListSandboxesRequest, ListSandboxesResponse>(
      this.edgeId,
      'WorkspaceService',
      'ListSandboxes',
      req
...
// ============================================================================
// WorkspaceService Service Descriptor (Embedded AI Metadata)
// ============================================================================

const descriptor: ServiceDescriptor = {
  name: "WorkspaceService",
  version: "1.0.0",
  description: "WorkspaceService manages sandbox lifecycle. Exposed on the Gondolin host edge (role=host). Called from Convex actions via callEdge().",
  methods: [
    {
      name: "ExecCommand",
...
// ============================================================================
// WorkspaceService Companion Object (Primary Export)
// ============================================================================

/**
 * WorkspaceService companion object with embedded AI metadata.
 * 
 * Usage:
 *   import { WorkspaceService } from './generated';
 *   
 *   // Create client
 *   const client = new WorkspaceService.Client(edgeId, caller);
 *   
 *   // Access embedded AI metadata (no network call)
 *   const serviceAI = WorkspaceService.descriptor.aiContext;
 *   const methodAI = WorkspaceService.getMethodAI('SomeMethod');
 *   const llmTxt = WorkspaceService.getLLMContext();
 */
export const WorkspaceService = {
  /** Client class for making RPC calls */
  Client: WorkspaceServiceClientImpl,
...
/** @deprecated Use WorkspaceService.Client instead */
export const WorkspaceServiceClient = WorkspaceServiceClientImpl;

/** @deprecated Use WorkspaceService.descriptor instead */
export const WorkspaceServiceDescriptor = descriptor;

/** @deprecated Use WorkspaceService.Definition instead */
export const WorkspaceServiceDefinition = definition;

/** @deprecated Use WorkspaceService.getLLMContext() instead */
export function getWorkspaceServiceLLMContext(): string {
