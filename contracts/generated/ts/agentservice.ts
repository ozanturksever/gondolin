...
class AgentServiceClientImpl {
  ...
  async CreateSession(req: CreateSessionRequest): Promise<CreateSessionResponse> {
    return this.caller.call<CreateSessionRequest, CreateSessionResponse>(
      this.edgeId,
      'AgentService',
      'CreateSession',
      req
  ...
  async SendMessage(req: SendMessageRequest): Promise<SendMessageResponse> {
    return this.caller.call<SendMessageRequest, SendMessageResponse>(
      this.edgeId,
      'AgentService',
      'SendMessage',
      req
  ...
  async TerminateSession(req: TerminateSessionRequest): Promise<TerminateSessionResponse> {
    return this.caller.call<TerminateSessionRequest, TerminateSessionResponse>(
      this.edgeId,
      'AgentService',
      'TerminateSession',
      req
  ...
  async ListSessions(req: ListSessionsRequest): Promise<ListSessionsResponse> {
    return this.caller.call<ListSessionsRequest, ListSessionsResponse>(
      this.edgeId,
      'AgentService',
      'ListSessions',
      req
  ...
  async GetEvents(req: GetEventsRequest): Promise<GetEventsResponse> {
    return this.caller.call<GetEventsRequest, GetEventsResponse>(
      this.edgeId,
      'AgentService',
      'GetEvents',
      req
  ...
  async ReplyQuestion(req: ReplyQuestionRequest): Promise<ReplyQuestionResponse> {
    return this.caller.call<ReplyQuestionRequest, ReplyQuestionResponse>(
      this.edgeId,
      'AgentService',
      'ReplyQuestion',
      req
  ...
  async ReplyPermission(req: ReplyPermissionRequest): Promise<ReplyPermissionResponse> {
    return this.caller.call<ReplyPermissionRequest, ReplyPermissionResponse>(
      this.edgeId,
      'AgentService',
      'ReplyPermission',
      req
...
// ============================================================================
// AgentService Service Descriptor (Embedded AI Metadata)
// ============================================================================

const descriptor: ServiceDescriptor = {
  name: "AgentService",
  version: "1.0.0",
  description: "AgentService manages AI agent sessions inside the Gondolin VM. Exposed on the VM edge (role=vm) via the dink-adapter sidecar. Proxies to sandbox-agent HTTP API on localhost:2468.",
  methods: [
    {
      name: "CreateSession",
...
// ============================================================================
// AgentService Companion Object (Primary Export)
// ============================================================================

/**
 * AgentService companion object with embedded AI metadata.
 * 
 * Usage:
 *   import { AgentService } from './generated';
 *   
 *   // Create client
 *   const client = new AgentService.Client(edgeId, caller);
 *   
 *   // Access embedded AI metadata (no network call)
 *   const serviceAI = AgentService.descriptor.aiContext;
 *   const methodAI = AgentService.getMethodAI('SomeMethod');
 *   const llmTxt = AgentService.getLLMContext();
 */
export const AgentService = {
  /** Client class for making RPC calls */
  Client: AgentServiceClientImpl,
...
/** @deprecated Use AgentService.Client instead */
export const AgentServiceClient = AgentServiceClientImpl;

/** @deprecated Use AgentService.descriptor instead */
export const AgentServiceDescriptor = descriptor;

/** @deprecated Use AgentService.Definition instead */
export const AgentServiceDefinition = definition;

/** @deprecated Use AgentService.getLLMContext() instead */
export function getAgentServiceLLMContext(): string {
